...
public static boolean getBoolean() {
        ...
        while (true) {
            String s = getWord();
            if ( s.equalsIgnoreCase("true") || s.equalsIgnoreCase("t") ||
                    s.equalsIgnoreCase("sim")  || s.equalsIgnoreCase("s") ||
                    s.equals("1") ) {
                ans = true;
                break;
            }
            else if ( s.equalsIgnoreCase("false") || s.equalsIgnoreCase("f") ||
                    s.equalsIgnoreCase("nao")  || s.equalsIgnoreCase("n") ||
                    s.equals("0") ) {
                ans = false;
                break;
            }
            else
                errorMessage("Valor não suportado",
                "true, false, t, f, sim, nao, s, n, 0 ou 1");
        } 
        inputErrorCount = 0;
        return ans;
    }
